...
import com.unipacifico_ingenieri_sistemas.tienda_virtual.mapper.UserMapper;
...
import com.unipacifico_ingenieri_sistemas.tienda_virtual.repository.RoleRepository;
import com.unipacifico_ingenieri_sistemas.tienda_virtual.repository.UserRepository;
...
public class UserService {
    ...
    public UserDto register(RegisterDto dto) {
        ...
        User user = userMapper.toEntity(dto, passwordEncoder.encode(dto.getPassword()), Set.of(clientRole));
