...
import com.unipacifico_ingenieria_sistemas.tienda_virtual.dto.OrderItemDto;
...
public class OrderMapper {
    ...
    public OrderDto toDto(Order order) {
        ...
        return OrderDto.builder()
            ...
            .clientFullName(order.getUsers().getFullName())
            .clientEmail(order.getUsers().getEmail())
